  ...
  return (
    <div className="px-4 pt-4 pb-24">
      ...
      <div className="bg-royal-card rounded-xl shadow-none p-4 mb-3">
              ...
              <div className="flex items-start gap-2">
                <div className="flex-1 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="block text-[10px] text-white/60 mb-0.5">Qty</label>
                      <input
                        type="number"
                        value={item.quantity || ''}
                    ...
                    <div>
                      <label className="block text-[10px] text-white/60 mb-0.5">Unit Price</label>
                      <input
                        type="number"
                ...
                {items.length > 1 && (
                  <button
                    ...
                    className="p-1 text-white/60 hover:text-red-500 mt-1"
                  >
        ...
        <button
          onClick={addItem}
          className="mt-2 w-full py-2 border border-dashed border-royal-dark text-white rounded-lg text-sm hover:border-indigo-400 hover:text-gold transition-colors"
        >
          + Add Item
        </button>
      </div>

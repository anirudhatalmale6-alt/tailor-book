        ...
        <div>
          ...
          <div className="flex gap-2 mb-4">
            <button
              ...
              className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 active:bg-indigo-800 transition-colors"
            >
              Take Measurements
            </button>
            {latestMeasurement && (
              <button
                ...
                className="py-3 px-4 bg-amber-50 border border-amber-200 text-amber-700 rounded-xl font-medium text-sm hover:bg-amber-100 transition-colors"
          ...
          <div className="space-y-3">
            ...
            {colleagues.length > 0 ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">{colleague.phone}</p>
                      </div>
                      <span className="text-xs text-green-600 font-medium">Send via WhatsApp</span>
                    </a>
                  );
                })}
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 text-center">
                <p className="text-sm text-gray-500 mb-2">No colleagues added yet</p>
                <p className="text-xs text-gray-400">Add a contact as &quot;Colleague&quot; to send measurements to them</p>
              </div>
            )}
          </div>
        ) : (
          <p className="text-sm text-gray-500">No measurements to send.</p>
        )}
      </Modal>
    </div>
  );

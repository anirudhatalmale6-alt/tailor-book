...
import { useCustomer, useCustomers, deleteCustomer } from '@/hooks/useCustomers';
      ...
      {(activeTab || 'measurements') === 'orders' && (
        <div>
          <button
            ...
            className="w-full mb-3 py-2.5 bg-gradient-to-r from-gold-dim to-gold text-white rounded-xl text-sm font-semibold flex items-center justify-center gap-2"
          >

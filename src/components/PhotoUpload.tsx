  ...
  return (
    ...
    >
      ...
      {value ? (
        ...
        <div className="w-full h-full bg-royal-hover rounded-xl flex flex-col items-center justify-center text-royal-muted border-2 border-dashed border-royal-dark">
